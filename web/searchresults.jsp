        ...
        <div class="table-responsive" style="text-align:center;position:relative;">
            <table class="table">
                ...
                <c:forEach items="${list}" var="flights">
                    <tr>
                        <td><h5>${flights.flight.flight_name}</h5> </td>
                        <td><h5>${flights.flight.from_city}</h5> </td>
                        <td><h5>${flights.flight.to_city}</h5></td>
                        <td><h5>${flights.flight.from_date}</h5> </td>
                        <%--<td><h5>${flights.flight.time}</h5> </td>--%>
                        <td><h5>${flights.totalSeats}</h5> </td>
                        <td><h5>${flights.seatType}</h5> </td>
                        <td><h5>${flights.price}</h5> </td>
                        <td>
                            <form method="post" action="/booking">
                                <input type="text" hidden name="flightid" value=${flights.flight.id}>
